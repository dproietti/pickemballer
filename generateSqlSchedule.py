...
for week in range(1,18):
    print "week: %s" % week
    games = week_schedule(year=2018, stype='REG', week=week)
    gameId = 0
    for game in games:
        gameId += 1
        print game
        ...
        schedule = Schedule(id=game['gamekey'], eid=game['eid'], week=game['week'], home_team=game['home'],away_team=game['away'],week_game_id=gameId)
